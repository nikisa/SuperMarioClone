...
public class EnemyAI : MonoBehaviour
{
    ...
    void CheckWalls (Vector2 pos , float direction) {
        ...
        if (wallTop.collider != null || wallMiddle.collider != null || wallBottom.collider != null) {
            ...
            if (hitRay.collider.tag == "Player") {
                hitRay.collider.gameObject.GetComponent<Player>().Life--;
                Debug.Log(hitRay.collider.gameObject.GetComponent<Player>().Life);
                if (hitRay.collider.gameObject.GetComponent<Player>().Life == 0) {
